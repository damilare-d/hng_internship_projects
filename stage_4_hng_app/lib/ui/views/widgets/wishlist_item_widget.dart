...
class WishListItem extends StatefulWidget {
  ...
  @override
  _wishLishItemState createState() => _wishLishItemState();
}

class _wishLishItemState extends State<WishListItem> {
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                height: 36,
                decoration:
                const BoxDecoration(color: Color.fromRGBO(0, 114, 198, 0.12)),
                child: IconButton(
                  onPressed: () {
