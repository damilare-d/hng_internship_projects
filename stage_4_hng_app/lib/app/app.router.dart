...
import 'package:stage_4_hng_app/ui/views/wishlist/wishlist_view.dart' as _i12;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i12.WishlistView: (data) {
      return _i13.MaterialPageRoute<dynamic>(
        builder: (context) => const _i12.WishlistView(),
        settings: data,
      );
    },
  };
